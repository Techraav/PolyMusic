...
@section('content')
	...
	<div class="jumbotron">
		...
		<p>Les niveaux définissent permettent de définir une hiérarchie entre les membres.</p>
	...
	<br />
		...
		<form method="post" action="{{ url('admin/level/create') }}">
			<table class="table">
			<tbody>
				<th>
				{{ csrf_field() }}
					<td><select class="form-control" name="filter">
