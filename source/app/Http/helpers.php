<?php
	...
	*/
	...
	function printFileInput($ext)
	{
		...
		$input = '<input onchange="fileInput(this)" data-extension="'.$str.'" class="input-file-hidden" type="file" />';
		$eglyph = '</span>';
		$name = '<span id="name"></span>';
		$ebtn = '</button>';

		return $sbtn.$sglyph.$input.$eglyph.$name.$ebtn;
	}
